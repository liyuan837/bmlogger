...
MySQL - 5.6.33-log : Database - db_bmlog
*********************************************************************
*/
...
CREATE TABLE `tb_logger_api` (
  ...
  `result_data` mediumtext COLLATE utf8_bin COMMENT '请求返回数据',
  `request_state` int(1) DEFAULT NULL COMMENT '接口调用结果状态，1表示正常，0表示抛出异常',
  PRIMARY KEY (`id`)
...
CREATE TABLE `tb_logger_type` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='日志类型';
