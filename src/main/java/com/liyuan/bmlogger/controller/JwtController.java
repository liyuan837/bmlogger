...
import com.liyuan.bmlogger.util.JwtUtil;
import com.liyuan.bmlogger.util.JwtUser;
...
//模拟登陆成功，返回token
    ...
    public ResponseEntity get(@RequestHeader("Authorization") String token) throws bmloggerException {
