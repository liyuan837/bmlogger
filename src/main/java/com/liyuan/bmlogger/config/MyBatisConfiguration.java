package com.liyuan.bmlogger.config;
...
@Configuration
@MapperScan(basePackages={"com.liyuan.bmlogger.mapper"},sqlSessionTemplateRef = "makeSqlSessionTemplate")
...
public class MyBatisConfiguration {
    ...
    public DataSource primaryDataSource() {
        ...
        hikariDataSource.setPoolName("bmlogger");
    ...
    public SqlSessionFactory makeSqlSessionFactoryBean(@Qualifier("dataSource")DataSource dataSource) throws Exception {
        ...
        sessionFactory.setTypeAliasesPackage("com.liyuan.bmlogger.domain");
