package com.liyuan.bmlogger.interceptor;

import com.liyuan.bmlogger.annotation.NotToken;
import com.liyuan.bmlogger.util.JSONUtil;
...
public class JwtInterceptor implements HandlerInterceptor{
    ...
    public boolean preHandle(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object handler) throws Exception {
        ...
        String authHeader = httpServletRequest.getHeader("authCode");

        if (authHeader == null || authHeader.equals("")) {
            //拦截，并且返回错误信息
            errorResponse(httpServletResponse,201,"尚未携带有效的authCode");
            return false;
        }else{
            return true;
        }
